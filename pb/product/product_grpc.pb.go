...
const (
	...
	ProductService_DeteleProduct_FullMethodName = "/go_grpc.ProductService/DeteleProduct"
)
...
type ProductServiceClient interface {
	GetProducts(ctx context.Context, in *Status, opts ...grpc.CallOption) (*Products, error)
	...
	DeteleProduct(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Status, error)
}
...
func (c *productServiceClient) GetProducts(ctx context.Context, in *Status, opts ...grpc.CallOption) (*Products, error) {
...
func (c *productServiceClient) DeteleProduct(ctx context.Context, in *Id, opts ...grpc.CallOption) (*Status, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Status)
	err := c.cc.Invoke(ctx, ProductService_DeteleProduct_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	GetProducts(context.Context, *Status) (*Products, error)
	...
	DeteleProduct(context.Context, *Id) (*Status, error)
...
func (UnimplementedProductServiceServer) GetProducts(context.Context, *Status) (*Products, error) {
...
func (UnimplementedProductServiceServer) DeteleProduct(context.Context, *Id) (*Status, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeteleProduct not implemented")
}
...
func _ProductService_GetProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProducts(ctx, req.(*Status))
	}
...
func _ProductService_DeteleProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Id)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).DeteleProduct(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_DeteleProduct_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).DeteleProduct(ctx, req.(*Id))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeteleProduct",
			Handler:    _ProductService_DeteleProduct_Handler,
		},
	},
